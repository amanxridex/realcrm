...
export default function Home() {
  ...
  const handleShare = (property: any) => {
    const text = `Check out this property:\n\n*${property.title}*\n📍 Location: ${property.location}\n💰 Price: ${property.price}\n📏 Size: ${property.beds} Bed, ${property.baths} Bath, ${property.sqft} sqft\n\nPurpose: For ${property.purpose || "Sell"}`;
    ...
    <>
      ...
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          ...
          />
          <button className="btn-primary upload-csv-btn" style={{ background: "var(--surface)", color: "var(--text-dark)", border: "1px solid var(--border)", boxShadow: "none" }} onClick={() => fileInputRef.current?.click()}>
              ...
              <div className="property-card" key={property.id}>
                ...
                <div className="property-content">
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: '1rem', justifyContent: 'flex-end' }}>
                    ...
                    <button className="btn-icon" title="Share" style={{ color: "var(--primary-color)", border: "none", background: "none", cursor: "pointer" }} onClick={() => handleShare(property)}>
                  ...
                  <tr key={property.id}>
                    ...
                    <td data-label="Actions">
                      <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
                        <button className="btn-icon" title="Share" onClick={() => handleShare(property)}>
