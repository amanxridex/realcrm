              ...
              <div className="property-card" key={property.id}>
                ...
                <div className="property-content">
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: '1rem', justifyContent: 'flex-end' }}>
                    ...
                    <button className="btn-icon" title="Share" style={{ color: "var(--primary-color)", border: "none", background: "none", cursor: "pointer" }} onClick={() => handleShare(property.id)}>
                  ...
                  <tr key={property.id}>
                    ...
                    <td data-label="Actions">
                      <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
                        <button className="btn-icon" title="Share" onClick={() => handleShare(property.id)}>
